...
# [RESSOURCE_ERRORS, SOURCE, RESSOURCE, SOURCE_LOCATION, RESSOURCE_LOCATION]
COLUMNS = enum(RESSOURCE_ERRORS=0, SOURCE=1, RESSOURCE=2, SOURCE_LOCATION=3, RESSOURCE_LOCATION=4)
